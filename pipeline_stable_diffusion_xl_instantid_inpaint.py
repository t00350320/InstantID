            ...
            for i, t in enumerate(timesteps):
                ...
                if len(control_mask_wight_image_lists) != 0:
                    down_block_res_samples = [
                                ...
                                for down_block_res_sample, mask_weight in zip(down_block_res_samples, control_mask_wight_image_lists[0])
                            ]
                mid_block_res_sample *= control_mask_wight_image_lists[0][-1]
